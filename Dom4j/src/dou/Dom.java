...
public class Dom {
	...
	/**
	 * <p> Iterate whole node from element use method paragraph to get
	 * text 
	 * @param Element abstract and body
	 *
	 * @return void
	 */
	...
	/**
	 * <p> paragraph get the all text from paragraph use StringSplice to take
	 * into sentences and three
	 * parts(authorandyear,citation,cintext) 
	 * @param Element
	 *        every paragraph
	 * @return void
	 *
	...
	/**
	 * <p> get text from contents 
	 * @param  Object content
	 *      every  paragraph's content
	 * @return String
	 *      return to method paragraph,is text of every element
	 * @throws
	 */
